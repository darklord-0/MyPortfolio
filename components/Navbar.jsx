  ...
  return (
    <div style={{backgroundColor:`${navBg}`}} className={ shadow ? 'fixed w-full h-20 shadow-xl z-[100] ' : 'fixed w-full h-20 z-[100] '}>
        <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
            <Link href='/#home'>
                <Image src="/../public/assets/pic2.jpg"  alt='/' width='125' height='50'></Image>
            </Link>
        ...
        <div className= {nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
            <div className={nav
                ? 'fixed left-0 top-0 w-[65%] sm:w-[55%] md:w[45%] h-screen bg-gray-100 p-10 ease-in duration-500'
                : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'
            }>
                <div>
                    <div className='flex w-full justify-between items-center'>
                        <Link href='/#home'>
                            <Image src="/../public/assets/pic2.jpg"  alt='/' width='80' height='35'></Image>
                        </Link>
                ...
                <div className='py-2 flex flex-col'> 
                    ...
                    <div className='pt-40 '>
                        <p className='uppercase tracking-widest text-[#4b46eb] text-xl'>
                            Let's Connect
                        </p>
